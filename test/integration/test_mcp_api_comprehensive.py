"""
Comprehensive API integration tests for Logos MCP server.

Tests the running docker stack with real MCP protocol interactions.
Covers tool discovery, execution, error handling, and performance.
"""
